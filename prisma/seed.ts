...
async function main() {
  ...
  const messages = [
    {
      ...
      resourceUrl: 'https://wearepcc.com/wp-content/uploads/study-guide-example.pdf',
  ...
  const smallGroups = [
    // Growth Groups
    {
      name: 'Lent Study',
      type: 'growth',
      description: 'Join us for a journey through Lent, exploring themes of sacrifice, renewal, and resurrection. This 6-week study uses daily readings and weekly group discussion.',
      ...
      currentMembers: 8,
      openForSignup: true,
      churchCenterUrl: 'https://wearepcc.churchcenter.com/groups',
      active: true,
    },
    {
      name: 'New Testament Letters',
      type: 'growth',
      description: 'A 6-week study diving into the letters of Paul and their relevance for today. Great for anyone wanting to understand the foundations of the early church.',
      leader: 'Pastor Mark',
      meetingDay: 'Tuesday',
      meetingTime: '7:00 PM',
      location: 'Redwood City',
      locationType: 'offcampus',
      ageGroup: 'adults',
      capacity: 12,
      currentMembers: 5,
      openForSignup: true,
    ...
    },
    {
      ...
      type: 'growth',
      description: 'New to faith or returning after time away? This welcoming 8-week study covers the basics of Christianity in a relaxed, question-friendly environment.',
      leader: 'Jeff S.',
      meetingDay: 'Sunday',
    ...
    // Life Groups
    {
      name: 'Young Families',
      type: 'life',
      description: 'An ongoing group for parents with young children (0-10). We share the joys and challenges of parenting while growing in faith together. Childcare provided.',
      leader: 'The Johnsons',
    ...
    },
    {
      name: 'Empty Nesters',
      type: 'life',
      description: 'For couples and individuals whose children have left home. We explore new seasons of life, faith, and purpose together with honesty and humor.',
      leader: 'The Smiths',
    ...
    },
    {
      name: 'Men\'s Group',
      type: 'life',
      description: 'Men supporting men in faith, work, and family life. Weekly meetings include Bible study, honest conversation, and accountability.',
      leader: 'Tom Anderson',
    ...
    },
    {
      name: 'Women\'s Group',
      type: 'life',
      description: 'A welcoming community of women growing in faith together through Bible study, prayer, and friendship. All women are welcome, wherever you are on your journey.',
      leader: 'Sarah Chen',
    ...
    },
    {
      name: 'Young Adults',
      type: 'life',
      description: 'For people in their 20s and 30s navigating career, relationships, and faith. We meet for dinner, discussion, and community. Come as you are.',
      leader: 'Mike & Jess',
      meetingDay: 'Friday',
      meetingTime: '7:00 PM',
      location: 'Redwood City',
    ...
    },
    {
      ...
      type: 'growth',
      description: 'Can\'t make it in person? Join our online study via Zoom. We work through a book of the Bible together with video teaching and group discussion.',
      leader: 'Karen B.',
      meetingDay: 'Monday',
      meetingTime: '7:30 PM',
  ...
  const supportResources = [
    {
      ...
      externalUrl: 'https://www.stephenministries.org/',
      order: 1,
      active: true,
    },
    {
    ...
    },
    {
      ...
      category: 'financial',
      description: 'For those seeking support in budgeting, debt consolidation, investment, and/or taxes. Our trained financial coach can help you navigate financial challenges with practical, biblically-grounded guidance.',
    ...
    },
    {
      ...
      category: 'counseling',
      description: 'We can connect you with recommended Christian counselors who integrate faith and clinical expertise. Whether you\'re navigating anxiety, depression, relationship struggles, or life transitions, professional support can make a real difference.',
      contactEmail: 'pastoral@wearepcc.com',
      order: 4,
      active: true,
    },
    {
      ...
      category: 'marriage',
      description: 'Resources and support for strengthening your marriage, including counseling referrals, marriage mentoring with experienced couples, and enrichment opportunities for every stage of your relationship.',
      contactEmail: 'pastoral@wearepcc.com',
      order: 5,
      active: true,
    },
